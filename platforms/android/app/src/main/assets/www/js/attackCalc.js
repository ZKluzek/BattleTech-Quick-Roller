...
function rollHitLocation(side, roll){
    if(!roll){
...
function quickAttack(){
    var roll = getRandomRoll(1,6);
    var locationHit = rollHitLocation(direction.value, roll);
    document.getElementById("rollResults").innerHTML += "Rolled a " + roll + ": " + locationHit + "<br>";
}
