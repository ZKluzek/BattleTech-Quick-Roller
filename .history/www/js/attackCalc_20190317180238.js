...
function clusterAttack(){
    var shotsHit = clusterShotsHit(Number(numShotsFired.value));
    ...
    var hitp = document.createElement("p");
    hitp.class="hitp";
    document.getElementById("p").innerHTML += hitText;
    
    document.getElementById("rollResults").append(hitp);
}

function createHitText(){
    var hitText = "";
    if( locationsHitArray.LT > 0 ){
        hitText += locationsHitArray.LT + " - " + possibleHitLocations.LTORSO + "<br>";
    }
    if( locationsHitArray.RT > 0 ){
        hitText += locationsHitArray.RT + " - " + possibleHitLocations.RTORSO + "<br>";
    }
    if( locationsHitArray.CT > 0 ){
        hitText += locationsHitArray.CT + " - " + possibleHitLocations.CTORSO + "<br>";
    }
    if( locationsHitArray.LL > 0 ){
        hitText += locationsHitArray.LL + " - " + possibleHitLocations.LLEG + "<br>";
    }
    if( locationsHitArray.RL > 0 ){
        hitText += locationsHitArray.RL + " - " + possibleHitLocations.RLEG + "<br>";
    }
    if( locationsHitArray.LA > 0 ){
        hitText += locationsHitArray.LA + " - " + possibleHitLocations.LARM + "<br>";
    }
    if( locationsHitArray.RA > 0 ){
        hitText += locationsHitArray.RA + " - " + possibleHitLocations.RARM + "<br>";
    }
    if( locationsHitArray.H > 0 ){
        hitText += locationsHitArray.H + " - " + possibleHitLocations.HEAD + "<br>";
    }
    return hitText;
}
