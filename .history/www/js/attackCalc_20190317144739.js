...
function clusterAttack(){
    var num = numShotsFired.value;
    for( var number in rollMultiples(num)){
        
    }
}

function rollMultiple(num){
    totalNumsRolled = {two:0,three:0,four:0,five:0,six:0,seven:0,eight:0,nine:0,ten:0,eleven:0,twelve:0};
    for(var i = 0; i < num; i++){
        tallyNums(getRandomRoll());
    }
    console.log(totalNumsRolled);
    return totalNumsRolled;
}
